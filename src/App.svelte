...
{#if $dbUser}
	...
	<div class="nav">
		...
		<svg
			...
			fill="currentColor"
			><path
				d="M1 0a1 1 0 0 1 1 1v14a1 1 0 0 1-2 0V1a1 1 0 0 1 1-1zm12 4a1 1 0 0 1 1 1v10a1 1 0 0 1-2 0V5a1 1 0 0 1 1-1zM7 8a1 1 0 0 1 1 1v6a1 1 0 0 1-2 0V9a1 1 0 0 1 1-1z"
			/></svg
		>
		<svg
			on:click={() => {
